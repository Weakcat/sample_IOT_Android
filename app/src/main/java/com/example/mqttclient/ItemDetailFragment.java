...
public class ItemDetailFragment extends Fragment implements MQTTService.IGetMessageCallBack {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.machine_state, container, false);//通过inflate把新的layout放在原本布局中
//        View rootView = inflater.inflate(R.layout.item_detail, container, false);

//        // Show the dummy content as text in a TextView.
//        if (mItem != null) {
//            ((TextView) rootView.findViewById(R.id.item_detail)).setText(mItem.details+"ggggg");//detail的内容
//        }
